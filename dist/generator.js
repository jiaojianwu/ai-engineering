...
exports.generateAIDocs = generateAIDocs;
/**
 * 生成AI工程化说明文档
 */
async function generateAIDocs(targetDir, config) {
 ...
 * 生成文档内容
 */
function generateDocsContent(config) {
 ...
 * 生成技能部分
 */
function generateSkillsSection(template) {
    return `
## 技能系统
